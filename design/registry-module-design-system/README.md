...
- `registry-module-design-system/README.md` — this file
- `registry-module-design-system/project/` — the `Registry module design system` project files (HTML prototypes, assets, components)
